...
@Serializable(with = ConfirmAttackDoneRequestSerializer::class)
data class ConfirmAttackDoneRequest(
    val lobbyCode: LobbyCode,
    val playerId: PlayerId,
) : NetworkMessagePayload

object ConfirmAttackDoneRequestSerializer : KSerializer<ConfirmAttackDoneRequest> {
    override val descriptor =
        buildClassSerialDescriptor(
            "at.aau.pulverfass.shared.network.message.ConfirmAttackDoneRequest",
        ) {
    ...
    override fun serialize(
        encoder: Encoder,
        value: ConfirmAttackDoneRequest,
    ) {
    ...
    override fun deserialize(decoder: Decoder): ConfirmAttackDoneRequest {
        ...
        composite.endStructure(descriptor)
        return ConfirmAttackDoneRequest(
            lobbyCode =
                lobbyCode
